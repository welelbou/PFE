                    ...
                    <div class="panel-body">
                        <div class="wrap-iten-in-cart">
                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    @if($order->status == 'livré' && $item->rstatus == false)
                        ...
                        <div class="summary">
                            <div class="order-summary">
                                <h4 class="title-box">Recapitilatif de l'ordre</h4>
                                <p class="summary-info"><span class="title">Total</span><b class="index">{{$order->subtotal}} MRU</b></p>
                                <p class="summary-info"><span class="title">Impot</span><b class="index">{{$order->tax}} MRU</b></p>
                                <p class="summary-info"><span class="title">Expedition</span><b class="index">Free Shipping</b></p>
                                <p class="summary-info"><span class="title">Totale</span><b class="index">{{$order->total}} MRU</b></p>
                            </div>
                        </div>
                    </div>
                </div>

                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @for($i=1;$i<=5;$i++) 
                                ...
                                @endif
                            @endfor
                            <a href="#" class="count-review">({{ $product->orderItems->where('rstatus',1)->count() }} Commentaire)</a>
                        </div>
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            ...
                            <a href="#review" class="tab-control-item">Commaintaires</a>
                        </div>
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="review">       
                                <div class="wrap-review-form">   
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">{{ $product->orderItems->where('rstatus',1)->count() }} Commenter sur <span>{{ $product->name }}</span></h2>
                                                ...
                                                <div id="comment-20" class="comment_container"> 
                                                    ...
                                                    <div class="comment-text">
                                                        <div class="star-rating">
                                                            <span class="width-{{ $orderItem->review->rating * 20 }}-percent">évalué <strong class="rating">{{ $orderItem->review->rating }}</strong> Sur 5</span>
                                                        </div>
                                                        <p class="meta"> 

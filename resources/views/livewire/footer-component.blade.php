...
--}}
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Nous utilisons des paiments sécurisés</h3>
								<div class="item-content">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Réseau sosial</h3>
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											{{-- <li><ahref="$setting->twitter }}" class="link-to-item" title="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>--}}
											<li><a href="{{ $setting->facebook }}" class="link-to-item" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
											{{-- <li><ahref="$setting->pinterest }}" class="link-to-item" title="pinterest"><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>--}}
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">À propos de nous</h3>
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											<p>
												Nous sommes une agence de transformation digitale. 
Nous sommes une équipe d’experts 
et de passionnés dévoués qui visent 
à transformer le paysage des affaires 
grâce à une application professionnelle 
de technologies de pointe. 
Nous développons des stratégies 
numériques sur mesure pour diverses
institutions allant des grandes entreprises 
comme les banques aux moyennes
et petites entreprises.
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">Nos services</h3>
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											Nous disposons d’outils de pointe pour élaborer 
des stratégies digitales sur mesure afin de 
transformer numériquement votre business.
Nous sommes à l’intersection de trois 
domaines technologiques clés : Software 
Development, Production Audiovisuelle
et le Marketing Digital.Chez IC-TECH, 

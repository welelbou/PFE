    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Categories de produits</span></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                <option value="default" selected="selected">Tri par defaut</option>
                                <option value="date">Trier par nouveauté</option>
                                <option value="price">Trier par prix: de bas en haut</option>
                                <option value="price-desc">Trier par prix: de haut au bas</option>
                            </select>
                        </div>
                ...
                <div class="wrap-pagination-info">
                    ...
                    <p class="result-count">Montrant 1-8 de 12 result</p>
                </div>

<main id="main" class="main-site">
    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            @endif
            <div class="wrap-iten-in-cart">
                <h3 class="title-box" style="border-botton: 1px solid; padding-bottom:15px;">{{ Cart::instance('saveForLater')->count() }} élément enregistré pour plus tard</h3>

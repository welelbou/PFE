    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                <option value="default" selected="selected">Trier par defaut</option>
                                <option value="date">Trier par nouveauté</option>
                                <option value="price">Trier par prix: De bas au haut</option>
                                <option value="price-desc">Trier par prix: en bas au haut</option>
                            </select>
                        </div>
                ...
                @else
                     <p style="padding-top:30px";>Aucun produit</p>
                @endif
